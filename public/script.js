...
tirarFoto.addEventListener('click', async () => {
  ...
  fotoCanvas.toBlob(async (blob) => {
    ...
    try {
      ...
      // Smooth scroll for internal anchors (keyboard friendly)
      ...
      // Small enhancement: lazy-load images already set via loading="lazy"
      // TODO: Consider intersection observer for progressive loading

      // Expose functions to global scope for potential future integration
